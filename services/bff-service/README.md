...
Account creation calls `otp-service` after the bank account is created. OTP service forwards the message to its configured SMS provider, and delivery failures are returned to the caller.
